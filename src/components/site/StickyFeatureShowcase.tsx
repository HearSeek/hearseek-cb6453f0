      ...
      <div className="container py-20 md:py-28">
        <div className="grid md:grid-cols-2 gap-10 md:gap-16">
          ...
          <div className="md:sticky md:top-24 md:self-start md:max-h-[calc(100vh-7rem)] flex">
            <div className="relative w-full rounded-3xl border border-border/60 bg-gradient-card p-6 md:p-8 shadow-elegant overflow-hidden flex flex-col justify-center">
